...
To support this paradigm, we introduce **Co-Clouds**, a large-scale dataset of ~45,000 coincident image patch pairs between **PlanetScope** and **Landsat-8**, collected within near-simultaneous temporal windows (30s). This dataset enables scalable training by leveraging Landsat-8's high-quality cloud masks generated by the CFMask algorithm as supervisory guidance for PlanetScope.
